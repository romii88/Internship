...
import com.highbury.internship.chat.db.DBManager;
import com.highbury.internship.chat.db.InviteMessage;
import com.highbury.internship.chat.db.InviteMessageStatus;
import com.highbury.internship.chat.db.InviteMessgeDao;
import com.highbury.internship.chat.db.RobotUser;
import com.highbury.internship.chat.db.UserDao;
...
//                    intent = new Intent(appContext, VoiceCallActivity.class);
                    ...
                    if (chatType == EMMessage.ChatType.Chat) { // single chat message
                        ...
                        intent.putExtra("chatType", ChatConstant.CHATTYPE_SINGLE);
                    } else { // group chat message
                        // message.getTo() is the group id
                        intent.putExtra("userId", message.getTo());
                        if(chatType == EMMessage.ChatType.GroupChat){
                            intent.putExtra("chatType", ChatConstant.CHATTYPE_GROUP);
                        }else{
                            intent.putExtra("chatType", ChatConstant.CHATTYPE_CHATROOM);
                        }
    ...
    public void login(String userName,String password,ChatRequestCallback callBack){
